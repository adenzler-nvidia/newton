...
class SolverMuJoCo(SolverBase):
    ...
    def _validate_tendon_attributes(model: Model) -> tuple[int, int]:
        ...
        # Joint-level attributes (for the linear combination)
    ...
    def _convert_to_mjc(
        ...
        *,
        ...
        shape_mapping = {}
        # mapping from Newton joint id to MuJoCo joint name
        joint_mapping = {}
        ...
        self._init_tendons(model, spec, joint_mapping, first_group)
