...
class SolverMuJoCo(SolverBase):
    ...
    def register_custom_attributes(cls, builder: ModelBuilder) -> None:
        ...
        **Custom frequencies:** ``mujoco:pair``, ``mujoco:actuator``,
        ``mujoco:tendon``, ``mujoco:tendon_joint``,
        ``mujoco:tendon_wrap``.

        See :ref:`mujoco-custom-attributes-and-frequencies` for the full
        catalog of all registered attributes and frequencies, and the
